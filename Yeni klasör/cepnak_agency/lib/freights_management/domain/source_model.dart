...
class Source extends ParseObject implements ParseCloneable, EquatableMixin {
  static const String _keyTableName = 'source';
  Source({
    String? objectId,
    String? name,
    String? picture,
  ...
  @override
  Source clone(Map<String, dynamic> map) => Source.clone()..fromJson(map);
